...
import { Inbox, ShieldCheck, Activity, CalendarDays } from 'lucide-react';
...
export default function ControlRail({ companyId }:{companyId:string}) {
  return <>
    <nav className="controlRail" aria-label="Control surfaces">
      ...
      <Link href={`/company/${companyId}/schedule`}><CalendarDays size={15}/><span>Tempo Operacional</span></Link>
