...
export default function MasterPage() {
  ...
  return <main className="masterShell">
    <aside className="masterSidebar"><div className="masterBrand"><div className="masterLogo">AI</div><div><strong>AI Company OS</strong><span>MASTER CONTROL</span></div></div><nav className="masterNav" aria-label="Master navigation"><Link href="/master" className="masterNavItem active"><Gauge size={17}/>Portfolio Overview</Link><Link href="/master/companies" className="masterNavItem"><Building2 size={17}/>Companies</Link><Link href="/master/workforce" className="masterNavItem"><Users size={17}/>AI Workforce</Link><Link href="/master/capital" className="masterNavItem"><CircleDollarSign size={17}/>Capital</Link><Link href="/master/risk" className="masterNavItem"><ShieldCheck size={17}/>Risk & Policies</Link></nav><div className="masterSidebarBottom"><div className="masterSystem"><i/>All systems operational</div><Link href="/" className="backLink">← Company OS</Link></div></aside>
