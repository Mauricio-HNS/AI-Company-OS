...
import { Activity, BrainCircuit, Bot, LayoutDashboard, Megaphone, Package, PlugZap, Scissors, Settings, ShieldCheck, Target, Users, Wallet, Zap } from 'lucide-react'

export type CompanyView = 'Dashboard'|'Agents'|'Missions'|'Tasks'|'Marketing'|'Customers'|'Products'|'Finance'|'Intelligence'|'Knowledge'|'Operations'|'Integrations'|'Security'|'Salon'|'Settings'
...
export const companyNavigation: NavigationGroup[] = [
  ...
  { title: 'BUSINESS', items: [{ label: 'Marketing', icon: Megaphone }, { label: 'Customers', icon: Users }, { label: 'Products', icon: Package }, { label: 'Finance', icon: Wallet }, { label: 'Salon', icon: Scissors }] },
